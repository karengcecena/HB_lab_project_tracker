...
--
-- Name: grades; Type: TABLE; Schema: public; Owner: karencecena
--
...
ALTER TABLE public.grades OWNER TO karencecena;

--
-- Name: grades_id_seq; Type: SEQUENCE; Schema: public; Owner: karencecena
--
...
ALTER TABLE public.grades_id_seq OWNER TO karencecena;

--
-- Name: grades_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: karencecena
--
...
--
-- Name: grades id; Type: DEFAULT; Schema: public; Owner: karencecena
--
...
--
-- Data for Name: grades; Type: TABLE DATA; Schema: public; Owner: karencecena
--
...
--
-- Name: grades_id_seq; Type: SEQUENCE SET; Schema: public; Owner: karencecena
--
...
--
-- Name: grades grades_pkey; Type: CONSTRAINT; Schema: public; Owner: karencecena
--
...
--
-- Name: grades grades_project_title_fkey; Type: FK CONSTRAINT; Schema: public; Owner: karencecena
--
...
--
-- Name: grades grades_student_github_fkey; Type: FK CONSTRAINT; Schema: public; Owner: karencecena
--
